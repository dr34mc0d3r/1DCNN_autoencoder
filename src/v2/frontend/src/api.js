...
export const api = {
  ...
  clusterProfile:    ()                  => _request("GET", "/cluster/profile"),
  clusterReps:       (cluster, n = 5)    => _request("GET", `/cluster/representatives?cluster=${cluster}&n=${n}`),
  clusterFwdReturns:   (horizon = 4)       => _request("GET", `/cluster/forward-returns?horizon=${horizon}`),
  clusterTransitions:  ()                  => _request("GET", "/cluster/transitions"),
