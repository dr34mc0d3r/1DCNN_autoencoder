...
│   └── src/pages/  7 pages: Config, Download, Train, Latent Space,
│                             Windows, Analysis, Live Inference
...
| POST | /api/cluster | Fit K-Means + t-SNE on all training windows |
| GET | /api/cluster | Cluster result (scatter, centroids) |
